...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($control->editar($_POST['nome'], $_POST['endereco'], $_POST['email'], $_POST['senha'], $_GET['id'])) {
            ...
            <div class="container h-100">
                <div class="dplay-tbl">
                    <div class="dplay-tbl-cell center-text color-white pt-90">
                        ...
                        <h3 class="mt-30 mb-15">Editar Cliente</h3>
                    </div><!-- dplay-tbl-cell -->
                </div><!-- dplay-tbl -->
            </div><!-- container -->
        </section>
        ...
        <section class="story-area left-text center-sm-text">
            <div class="container">
                ...
                <form action="" method="POST" id="form" class="form-style-1 placeholder-1">
                    <div class="row">
                        <div class="col-md-6">Nome: <br> <input class="mb-20" name="nome" id="nome" required="required" type="text" placeholder="Nome" value="<?php echo $obj->nome; ?>">  </div>
                        <div class="col-md-6">Endereço: <br> <input class="mb-20" name="endereco" id="endereco" required="required" type="text" placeholder="Endereço" value="<?php echo $obj->endereco; ?>">  </div>
                        <div class="col-md-6">Email: <br> <input class="mb-20" name="email" id="email" required="required" type="email" placeholder="Email" value="<?php echo $obj->email; ?>">  </div>
