            ...
            <div class="container h-100">
                <div class="dplay-tbl">
                    <div class="dplay-tbl-cell center-text color-white pt-90">
                        ...
                        <h3 class="mt-30 mb-15">Listar Reservas</h3>
                    </div><!-- dplay-tbl-cell -->
                </div><!-- dplay-tbl -->
            </div><!-- container -->
        </section>
                        ...
                        <div class="swiper-wrapper pb-90 pb-sm-60 left-text center-sm-text">
                            ...
                            <?php if ($obj) { foreach ($obj as $o) { ?>
                                <div class="swiper-slide">
                                    <h4><?php echo $o->data ?></h4>
                                    <p class="color-ash mb-50 mb-sm-30 mt-20">Mesa: <?php foreach ($mesas as $m) {if ($m->id == $o->idMesa) {echo $m->numero . " (" . $m->lugares . " lugares)";}} ?><br>Cliente: <?php if ($clientes) foreach ($clientes as $c) {if ($c->id == $o->idCliente) {echo $c->email . " (" . $c->nome . ", " . $c->cpf . ")";}} ?></p>
                            ...
                            <?php $mesas = $ctrlMesa->listar(); $clientes = $ctrlCliente->listar(); } } ?>
        ...
        <script>
            $(document).ready(function () {
                $(".editar").click(function () {
                    id = $(this).attr("rel");
                    $(location).attr("href", "editar-reserva.php?id=" + id);
                });
