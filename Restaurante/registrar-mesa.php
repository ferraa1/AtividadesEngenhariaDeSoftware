...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($control->inserir($_POST['numero'], $_POST['lugares'])) {
            ...
            <div class="container h-100">
                <div class="dplay-tbl">
                    <div class="dplay-tbl-cell center-text color-white pt-90">
                        ...
                        <h3 class="mt-30 mb-15">Registrar Mesa</h3>
                    </div><!-- dplay-tbl-cell -->
                </div><!-- dplay-tbl -->
            </div><!-- container -->
        </section>
        ...
        <section class="story-area left-text center-sm-text">
            <div class="container">
                ...
                <form action="" method="POST" id="form" class="form-style-1 placeholder-1">
                    <div class="row">
                        <div class="col-md-6">Número: <br> <input class="mb-20" name="numero" id="numero" required="required" type="number" placeholder="Número" value="" min="0">  </div>
                        <div class="col-md-6">Lugares: <br> <input class="mb-20" name="lugares" id="lugares" required="required" type="number" placeholder="Lugares" value="" min="2">  </div>
                    </div><!-- row -->
