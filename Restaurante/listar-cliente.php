            ...
            <div class="container h-100">
                <div class="dplay-tbl">
                    <div class="dplay-tbl-cell center-text color-white pt-90">
                        ...
                        <h3 class="mt-30 mb-15">Listar Clientes</h3>
                    </div><!-- dplay-tbl-cell -->
                </div><!-- dplay-tbl -->
            </div><!-- container -->
        </section>
                        ...
                        <div class="swiper-wrapper pb-90 pb-sm-60 left-text center-sm-text">
                            ...
                            <?php if ($obj) { foreach ($obj as $o) { ?>
                                <div class="swiper-slide">
                                    <h4><?php echo $o->nome ?></h4>
                                    <p class="color-ash mb-50 mb-sm-30 mt-20">CPF: <?php echo $o->cpf ?><br>Nascimento: <?php echo $o->nascimento ?><br>Endereço: <?php echo $o->endereco ?><br>Email: <?php echo $o->email ?></p>
