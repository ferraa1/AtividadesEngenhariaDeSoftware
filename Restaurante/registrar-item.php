...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($control->inserir($_POST['descricao'], $_POST['valor'], $_POST['observacao'])) {
            ...
            <div class="container h-100">
                <div class="dplay-tbl">
                    <div class="dplay-tbl-cell center-text color-white pt-90">
                        ...
                        <h3 class="mt-30 mb-15">Registrar Item</h3>
                    </div><!-- dplay-tbl-cell -->
                </div><!-- dplay-tbl -->
            </div><!-- container -->
        </section>
        ...
        <section class="story-area left-text center-sm-text">
            <div class="container">
                ...
                <form action="" method="POST" id="form" class="form-style-1 placeholder-1">
                    <div class="row">
                        <div class="col-md-6">Descrição: <br> <input class="mb-20" name="descricao" id="descricao" required="required" type="text" placeholder="Descrição" value="">  </div>
                        <div class="col-md-6">Valor: <br> <input class="mb-20" name="valor" id="valor" required="required" type="number" placeholder="Valor" value="" min="0">  </div>
                        <div class="col-md-6">Observação: <br> <input class="mb-20" name="observacao" id="observacao" type="text" placeholder="Observação" value="">  </div>
                    </div><!-- row -->
