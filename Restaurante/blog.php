            ...
            <div class="container h-100">
                <div class="dplay-tbl">
                    <div class="dplay-tbl-cell center-text color-white pt-90">
                        ...
                        <h3 class="mt-30 mb-15">Nosso Blog</h3>
                    </div><!-- dplay-tbl-cell -->
                </div><!-- dplay-tbl -->
            </div><!-- container -->
        </section>
                ...
                <div class="row">
                    <div class="col-md-7 col-lg-8">
                        ...
                        <div class="mb-50 mb-sm-30">
                            ...
                            <h4><a href="#"><b>O segredo da pizza perfeita</b></a></h4>
                            <h6 class="mt-10 bg-lite-blue dplay-inl-block">
                                <a class="plr-20 mtb-10" href="#"><b>Por Admin</b></a>
                                <a class="plr-20 mtb-10 brder-lr-lite-black-2" href="#"><b>em Receitas</b></a>
                                <a class="plr-20 mtb-10" href="#"><b>3 Comentários</b></a>
                            </h6>
                        ...
                        <div class="mb-50 mb-sm-30">
                            ...
                            <h4><a href="#"><b>A melhor receita de raviolli</b></a></h4>
                            <h6 class="mt-10 bg-lite-blue dplay-inl-block">
                                <a class="plr-20 mtb-10" href="#"><b>Por Admin</b></a>
                                <a class="plr-20 mtb-10 brder-lr-lite-black-2" href="#"><b>em Receitas</b></a>
                                <a class="plr-20 mtb-10" href="#"><b>2 Comentários</b></a>
                            </h6>
                            <p class="mt-30">Proin dictum viverra varius. Etiam vulputate libero dui, at pretium elit
                                elementum quis. Enean porttitor eros non ultrices convallis. Vivamus quis dolor ut arcu lobortis finibus a vitae leo.
                                Sed eget tempus sem. Nullam sed lacus sed metus tincidunt lobortis lobortis at nibh. Morbi euismod, arcu in gravida rhoncus</p>
                        ...
                        <div class="mb-50 mb-sm-30">
                            ...
                            <h4><a href="#"><b>Receita da semana: Tomatão Frito</b></a></h4>
                            <h6 class="mt-10 bg-lite-blue dplay-inl-block">
                                <a class="plr-20 mtb-10" href="#"><b>Por Admin</b></a>
                                <a class="plr-20 mtb-10 brder-lr-lite-black-2" href="#"><b>em Receitas</b></a>
                                <a class="plr-20 mtb-10" href="#"><b>3 Comentários</b></a>
                    ...
                    <div class="col-md-5 col-lg-4">
                        <div class="mx-w-400x mlr-auto">
                            <form class="mb-50 mb-sm-30 mt-sm-30 placeholder-1 form-style-1 pos-relative">
                                <input class="pr-50" type="text" placeholder="Procurar">
                            ...
                            <div class="mb-50 mb-sm-30 pos-relative oflow-hidden">
                                ...
                                <div class="abs-bl font-18 color-white p-30 z-1">
                                    ...
                                    <h6 class="font-5 mt-10">Combo <b>Pizza + Salada</b></h6>
                                </div>
                            </div><!--mb-50-->

                            <div class="mb-50 mb-sm-30">
                                <h5 class="left-text"><b>Inscreva-se na nossa newsletter</b></h5>
                                <form class="placeholder-1 form-style-1 pos-relative">
                                    <input class="mtb-20" type="text" placeholder="Seu email aqui">
                                    <button class="w-100 btn-primaryc" type="submit">inscrever-se</button>
                                </form>
                            </div><!--mb-50-->

                            <div class="mb-50 mb-sm-30">
                                <h5 class="mb-30 left-text"><b>Últimos Posts</b></h5>
                                <div class="sided-90x mb-30 ">
                                    <div class="s-left"><img class="br-3" src="images/sidebar-3-200x200.jpg" alt="Menu Image"></div>
                                    <div class="s-right left-text">
                                        <h6 class="color-semi-black">Receitas</h6>
                                        <h6 class="font-11 mtb-5"><b>A Melhor Receita</b></h6>
                                        <h6 class="color-primary"><b>Maio  22, 2018</b></h6>
                                    </div><!--s-right-->
                                </div><!-- sided-90x -->
                                ...
                                <div class="sided-90x mb-30 ">
                                    ...
                                    <div class="s-right left-text">
                                        <h6 class="color-semi-black">Receitas</h6>
                                        <h6 class="font-11 mtb-5"><b>O Segredo</b></h6>
                                        <h6 class="color-primary"><b>Maio  22, 2018</b></h6>
                                    </div><!--s-right-->
                                </div><!-- sided-90x -->
                                ...
                                <div class="sided-90x mb-30 ">
                                    ...
                                    <div class="s-right left-text">
                                        <h6 class="color-semi-black">Receitas</h6>
                                        <h6 class="font-11 mtb-5"><b>Limonada </b></h6>
                                        <h6 class="color-primary"><b>Maio  22, 2018</b></h6>
                                    </div><!--s-right-->
                                </div><!-- sided-90x -->
                            </div><!--mb-50-->
                            ...
                            <div class="mb-30 pos-relative">
                                ...
                                <div class="font-23  ptb-15 abs-tlr-30 color-white center-text brdr-primary-3">
                                    ...
                                    <h4><b>1 + 1</b></h4>
                                    <h6 class="font-5 pb-15"><b>Compre um ganhe um</b></h6>
                                </div>
                            </div><!--mb-50-->
