            ...
            <div class="container h-100">
                <div class="dplay-tbl">
                    <div class="dplay-tbl-cell center-text color-white pt-90">
                        ...
                        <h3 class="mt-30 mb-15">Registrar Reserva</h3>
                    </div><!-- dplay-tbl-cell -->
                </div><!-- dplay-tbl -->
            </div><!-- container -->
        </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">Cliente: <br> 
                            ...
                            <select class="form-control" name="cliente">
                                <option value="" placeholder="Cliente" required="required"> </option>
                                <?php foreach ($clientes as $c) { ?>
                                    <option value="<?php echo $c->id ?>"><?php echo $c->email ?> (<?php echo $c->nome ?>, <?php echo $c->cpf ?>)</option>
                                <?php } ?>
                            </select>
