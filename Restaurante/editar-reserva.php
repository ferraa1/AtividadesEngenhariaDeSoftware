...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($control->editar($_POST['data'], $_POST['horario'], $_POST['mesa'], $_GET['id'])) {
            ...
            <div class="container h-100">
                <div class="dplay-tbl">
                    <div class="dplay-tbl-cell center-text color-white pt-90">
                        ...
                        <h3 class="mt-30 mb-15">Editar Reserva</h3>
                    </div><!-- dplay-tbl-cell -->
                </div><!-- dplay-tbl -->
            </div><!-- container -->
        </section>
        ...
        <section class="story-area left-text center-sm-text">
            <div class="container">
                ...
                <form action="" method="POST" id="form" class="form-style-1 placeholder-1">
                    <div class="row">
                        <div class="col-md-6">Data: <br> <input class="mb-20" name="data" id="data" required="required" type="date" placeholder="Data" value="<?php echo $array[0] ?>" min="<?php echo $tomorrow; ?>">  </div>
                        <div class="col-md-6">Horário: <br> <input class="mb-20" name="horario" id="horario" required="required" type="time" placeholder="Horário" value="<?php echo $array[1] ?>" min="18:00" max="22:00">  </div>
                        ...
                        <div class="col-md-6">Número da Mesa: <br> 
                            ...
                            <select class="form-control" name="mesa">
                                ...
                                <?php foreach ($mesas as $m) { ?>
                                    <option <?php if ($m->id == $obj->idMesa) echo "selected" ?> value="<?php echo $m->id ?>"><?php echo $m->numero ?> (<?php echo $m->lugares ?> lugares)</option>
                                <?php } ?>
                            </select>
